...
if current_process().name != "__actor__":
    ...
    requirements_path_items = (
        ('requirements/win-openvino.txt', 'Windows', 'Windows with Intel CPU, iGPU, dGPU'),
    )
    ...
    def register():
        ...
        bpy.types.Scene.dream_textures_upscale_tile_size = IntProperty(name="Scale Factor", default=4, step=1, min=1, max=4)
