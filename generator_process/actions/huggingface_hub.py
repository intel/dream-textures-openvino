...
class ModelType(enum.IntEnum):
    ...
    def recommended_model(self) -> str:
        ...
        match self:
            ...
            case ModelType.PROMPT_TO_IMAGE_INT8:
                return "Stable_Diffusion_1_5_int8"            
            case ModelType.DEPTH:
                return "Stable_Diffusion_1_5_controlnet_depth"
            case ModelType.DEPTH_INT8:
                return "Stable_Diffusion_1_5_controlnet_depth_int8"            
                #return "Stable_Diffusion_2_1_depth"
