...
class Generator(Actor):
    ...
    from .actions.prompt_to_image import prompt_to_image, choose_device, load_models
    from .actions.prompt_to_image_int8 import prompt_to_image_int8, load_models_int8
    ...
    #from .actions.depth_to_image import depth_to_image,load_models_depth
    from .actions.controlnet_depth_to_image import depth_to_image,load_models_depth
    from .actions.controlnet_depth_to_image_int8 import depth_to_image_int8,load_models_depth_int8
