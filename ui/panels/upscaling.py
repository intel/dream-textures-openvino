    ...
    for space_type in SPACE_TYPES:
        class UpscalingPanel(Panel):
            ...
            def draw(self, context):
                ...
                layout.prop(context.scene.dream_textures_upscale_prompt, "infer_device")  
            ...
            def draw(self, context):
                ...
                if context.scene.dream_textures_progress <= 0:
                    if context.scene.dream_textures_info != "":
                        ...
                        row.operator(
                            Upscale.bl_idname,
                            text=f"Upscale Image", #to {image.size[0] * 4}x{image.size[1] * 4}" if image is not None else "Upscale",
